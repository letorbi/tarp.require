...
a.loaded=!0}return e.m}function l(e){function f(a,g,c){function b(b){var d=/package\.json$/;return d.test(b.u)&&!d.test(g)?(b=t(b,e),"string"==typeof b.exports.main?l(b)(b.exports.main,c):b.exports):1==a?b.u:2==a?[f.match(/.*\//)[0]]:t(b,e).exports}var f=(new URL("."==g[0]?e?e.uri:d.root:d.paths[0],d.root)).href;return c?new Promise(function(a,d){n(g,f,c).p.then(b).then(a,d)}):b(n(g,f,c))}var a=f.bind(void 0,0);a.resolve=f.bind(a,1);a.resolve.paths=f.bind(a.resolve,2);return a}var k=Object.create(null);
